/* ============================================================
   ACTIONS.JS — Frise chronologique de la page "Nos actions"
   Ordre du tableau : du plus récent (index 0) au plus ancien (index N).
   ============================================================ */

(function () {
    const YEARS = [2006, 2014, 2016, 2018, 2019, 2021, 2022, 2023, 2024, 2025];
    let activeYear = 2025;
    ...
    window.toggleYear = function (year) { switchToYear(year); };
    window.closeOpenSection = window.toggleYear;
})();
